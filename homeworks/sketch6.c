...
int main()
{
    while (1)
    {
        ...
        case 'd':
            ...
            printf("Longest steps: %s",data[lng].steps);
            break;
        ...
        case 'f':
            ...
            printf("Longest period start: %s %s\n",data[lng_interval[max_index].start+1].date,data[lng_interval[max_index].start+1].time);
            printf("Longest period end: %s %s\n",data[lng_interval[max_index].end+1].date,data[lng_interval[max_index].end+1].time);
            break;
